...
![Build](https://github.com/NatLabRockies/SAM/actions/workflows/ci.yml/badge.svg)
...
The [SAM release notes](https://natlabrockies.github.io/SAM/doc/releasenotes.html) are in https://github.com/NatLabRockies/SAM/blob/gh-pages/doc/releasenotes.html.

The desktop version of SAM for Windows, Mac, or Linux builds from the following open source projects:

* [SSC](https://github.com/NatLabRockies/ssc) is a set of "compute modules" that simulate different kinds of power systems and financial structures. It can be run directly using the [SAM Software Development Kit](https://sam.nlr.gov/sdk). **This is the source code for SAM's models, and is the repository to use for researching the algorithms underlying the models.**

* [LK](https://github.com/NatLabRockies/lk) is a scripting language that is integrated into SAM. SAM's user interface uses LK to calculate values to display on input pages. The user interface includes a script editor that allows users to write their own scripts from the user interface.
...
* [WEX](https://github.com/NatLabRockies/wex) is a set of extensions to wxWidgets for custom user-interface elements developed specifically for SAM, LK script, and DView.
...
For build instructions see the [wiki](https://github.com/NatLabRockies/SAM/wiki) with specific instructions for:

  * [Windows](https://github.com/NatLabRockies/SAM/wiki/Windows-Build-Instructions)
  * [Mac](https://github.com/NatLabRockies/SAM/wiki/Mac-Build-Instructions)
  * [Linux](https://github.com/NatLabRockies/SAM/wiki/Linux-Build-Instructions)

# Contributing

If you would like to report an issue with SAM or make a feature request, please let us know by adding a new issue on the [issues page](https://github.com/NatLabRockies/SAM/issues).
...
# License
SAM's open source code is copyrighted by the Alliance for Energy Innovation and licensed with BSD-3-Clause terms, found [here](https://github.com/NatLabRockies/SAM/blob/develop/LICENSE).

The stepwise and LHS [LGPL](https://www.gnu.org/licenses/lgpl-3.0.en.html) licensed libraries from Sandia National Laboratories are pre-compiled Fortran libraries that are included in the SAM repository as binaries in the [Sandia folder](https://github.com/NatLabRockies/SAM/tree/develop/Sandia). You can replace the binaries with different versions by compiling your own version and replacing the binary/executable viles in the Sandia folder.
