...
For more information about the model, including a demonstration video and technical reference manuals, see the `SAM website <https://sam.nrel.gov/concentrating-solar-power.html>`__.
