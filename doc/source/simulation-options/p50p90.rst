...
.. note:: For a description of SAM's P50/P90 methodology, see Dobos, A. P.; Gilman, P.; Kasberg, M. (2012). P50/P90 Analysis for Solar Energy Systems Using the System Advisor Model: Preprint. 8 pp.; NREL Report No. CP-6A20-54488. (`PDF 372 KB <https://docs.nrel.gov/docs/fy12osti/54488.pdf>`__) Before running P50/P90 simulations:
