...
For a video demonstration of stochastic simulations in SAM, see `Parametric and Statistical Analysis in SAM <https://sam.nrel.gov/simulation-options.html>`__.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SAM's Create Tornado Chart macro in an LK script that you can use to generate a tornado graph given a set of statistical distributions and input variables. See the `Parametric and Statistical Analysis videos <https://sam.nrel.gov/simulation-options.html>`__ for a video demonstration.
