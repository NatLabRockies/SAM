...
.. note:: SAM uses the following method to calculate monthly and annual kWh totals from kW time series data:


.. note:: *  Monthly Total (kWh) = SUM OVER MONTH( Time Series Value (kW/time step) × Time Steps per Hour (1/h) )*
