...
This topic describes the inputs on the Financial Parameters page for the Single Owner financial model. For a general description of the model, see :doc:`Financial Models <../introduction/fin_overview>`.
