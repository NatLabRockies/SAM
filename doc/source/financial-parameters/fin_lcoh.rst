...
*Cost of Electricity ($/yr) = Annual Electricity Consumption w/ Avail Derate (kWhe/yr) × Electricity Rate ($/kWh)*

You can see the calculated parasitic load on the Results page after running a simulation:
