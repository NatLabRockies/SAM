...
This topic describes the inputs on the Financial Parameters page for the Leveraged Partnership Flip financial model. For a general description of financial structures SAM can model, see :doc:`Financial Models <../introduction/fin_overview>`.
...
.. include:: ../includes/snip_financing_equity_investment.rst
