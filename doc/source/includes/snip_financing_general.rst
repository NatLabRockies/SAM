...
**Inflation Rate**
  ...
  The default value of 2.5% is based on `consumer price index data from the U.S. Department of Labor Bureau of Labor Statistics <http://stats.bls.gov/cpi/tables.htm>`__, and is the average of the annual average consumer price index between 1991 and 2012.
