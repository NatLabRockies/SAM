...
.. note:: If you are modeling :doc:`grid outages <../grid/grid_outage>` to calculate resiliency metrics, during an outage the battery switches to a special dispatch mode that prioritizes meeting the load, regardless of the dispatch option you choose.
