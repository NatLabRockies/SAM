...
:doc:`Operating Costs <../operating-costs/operating_costs>` are in Years 1 and later of the cash flow:

* Costs for labor, equipment, and other costs associated with operating and maintaining the project

You can also specify costs associated with financing the project on the :doc:`Financial Parameters <../financial-parameters/fin_overview>` page:
