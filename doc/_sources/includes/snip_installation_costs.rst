...
SAM uses the variables on the Installation Costs page to calculate the project investment cost and annual operating costs reported in the project :doc:`cash flow <../results/cashflow>` and used to calculate cost metrics.
