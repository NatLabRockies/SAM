...
.. note:: Land lease costs are not available for the distributed behind-the-meter financial models: Residential, Commercial, or Third Party Ownership models.
...
**Annual land lease cost, $/acre or $/ha**
  The annual lease cost. Choose the units to specify the cost in either $/acre or $/hectare. You can specify the cost in Year 1 dollars with an optional escalation rate, or click |SS_AnnSched-valschedbutton| to specify the cost by year.
