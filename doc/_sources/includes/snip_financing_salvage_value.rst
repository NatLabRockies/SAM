...
SAM considers the salvage value to be project income in the final year of the project cash flow, and calculates the value as a percentage of the total installed cost from the :doc:`Operating Costs <../operating-costs/operating_costs>` page.
...
**End of Analysis Period Salvage Value**
  The salvage value dollar amount that will appear in final year of the project :doc:`cash flow <../results/cashflow>`  .
