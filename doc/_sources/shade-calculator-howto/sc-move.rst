...
#. Hover over a handle to see the move pointer |ss-icon-move|:
...
#. Type values for the object's X, Y, and Z coordinates (the scene's origin is at the intersection of the X, Y, and Z axes)  Be sure to press the Tab or Enter key to store each value: 
...
.. image:: ../images/ss-move-3d-scene.png
   :align: center
   :alt: ss-move-3d-scene.png



.. |ss-icon-move| image:: ../images/ss-icon-move.png
