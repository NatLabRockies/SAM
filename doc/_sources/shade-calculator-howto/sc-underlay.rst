...
#. Type a street address for **Address** and click******Lookup address**,
...
#. :doc:`Define the scene location <sc-define-location>`.

#. Click **Load image** and open the image file, or click **Paste image** to load an image from your computer's clipboard.

#. Type the image scale. (You can use image editing software to estimate the number of meters per 100 pixels.)

Set the scale for the image underlay by hand

#. Click **Manual scale**.

#. Type a value for the number of meters represented by each 100 pixels in the image. The scale bar at the top left corner of the image indicates the length of 100 pixels.

Use the loaded image as an underlay in the bird's eye view

#. Load a map image using one of the two methods described above.

#. Click **Underlay this map****in the scene**.
...
#. Click **Remove underlay****in scene**.
