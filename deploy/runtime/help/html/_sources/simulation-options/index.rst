...
You can :doc:`run simulations <../getting-started/run_simulations>` from SAM, or from a :doc:`macro or script <macros>`.

Multiple Simulations
~~~~~~~~~~~~~~~~~~~~

Some analysis scenarios require more than one simulation. For example, an optimization may require running simulations for a range of values for one or more input variables. SAM offers three options for multiple simulations:
...
You can also design your own models that require multiple simulations by writing a :doc:`script <../simulation-options/macros>` in SAM, or you can call the SAM simulation core (SSC) outside of SAM with the :doc:`software development kit <../reference/sdk>`.

Simulation Option Topics
~~~~~~~~~~~~~~~~~~~~~~~~
