...
.. note:: If you are modeling a supercritical Carbon dioxide (sCO2) cycle, you can use the **sCO2 Cycle Integration** :doc:`macro <../simulation-options/macros>` with the` NLR Supercritical Carbon Dioxide (sCO2) Python model <https://github.com/NatLabRockies/SAM/tree/develop/samples/CSP/sco2_analysis_python_V2>`__. SAM 2020.2.29 is the most recent version to include an sCO2 option on the Power Cycle page.
