...
.. note:: You can use SAM's Weather File Converter :doc:`macro <../simulation-options/macros>` to convert from these and other weather file formats including PVsyst CSV, PVGIS 5 CSV, and SolarAnywhere to the SAM CSV format.
