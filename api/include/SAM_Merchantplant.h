...
extern "C"
{
	 ...
	 * required if: ?=0
	 */
	SAM_EXPORT void SAM_Merchantplant_TaxCreditIncentives_itc_fed_amount_aset(SAM_table ptr, double* arr, int length, SAM_error *err);
	 ...
	 * required if: ?=0
	 */
	SAM_EXPORT void SAM_Merchantplant_TaxCreditIncentives_itc_fed_percent_aset(SAM_table ptr, double* arr, int length, SAM_error *err);
	 ...
	 * required if: ?=1e99
	 */
	SAM_EXPORT void SAM_Merchantplant_TaxCreditIncentives_itc_fed_percent_maxvalue_aset(SAM_table ptr, double* arr, int length, SAM_error *err);
	 ...
	 * required if: ?=0
	 */
	SAM_EXPORT void SAM_Merchantplant_TaxCreditIncentives_itc_sta_amount_aset(SAM_table ptr, double* arr, int length, SAM_error *err);
	 ...
	 * required if: ?=0
	 */
	SAM_EXPORT void SAM_Merchantplant_TaxCreditIncentives_itc_sta_percent_aset(SAM_table ptr, double* arr, int length, SAM_error *err);
	 ...
	 * required if: ?=1e99
	 */
	SAM_EXPORT void SAM_Merchantplant_TaxCreditIncentives_itc_sta_percent_maxvalue_aset(SAM_table ptr, double* arr, int length, SAM_error *err);
	 ...
	 */
	SAM_EXPORT void SAM_Merchantplant_Depreciation_depr_basis_mat_mset(SAM_table ptr, double* mat, int nrows, int ncols, SAM_error *err);
	 ...
	 * required if: ?=0
	 */
	SAM_EXPORT void SAM_Merchantplant_Depreciation_depr_en_basis_mat_nset(SAM_table ptr, double number, SAM_error *err);
	 ...
	 * required if: ?=0
	 */
	SAM_EXPORT void SAM_Merchantplant_BatterySystem_en_wave_batt_nset(SAM_table ptr, double number, SAM_error *err);
	...
	SAM_EXPORT double* SAM_Merchantplant_TaxCreditIncentives_itc_fed_amount_aget(SAM_table ptr, int* length, SAM_error *err);
	...
	SAM_EXPORT double* SAM_Merchantplant_TaxCreditIncentives_itc_fed_percent_aget(SAM_table ptr, int* length, SAM_error *err);
	...
	SAM_EXPORT double* SAM_Merchantplant_TaxCreditIncentives_itc_fed_percent_maxvalue_aget(SAM_table ptr, int* length, SAM_error *err);

	SAM_EXPORT double* SAM_Merchantplant_TaxCreditIncentives_itc_sta_amount_aget(SAM_table ptr, int* length, SAM_error *err);
	...
	SAM_EXPORT double* SAM_Merchantplant_TaxCreditIncentives_itc_sta_percent_aget(SAM_table ptr, int* length, SAM_error *err);
	...
	SAM_EXPORT double* SAM_Merchantplant_TaxCreditIncentives_itc_sta_percent_maxvalue_aget(SAM_table ptr, int* length, SAM_error *err);
	...
	SAM_EXPORT double* SAM_Merchantplant_Depreciation_depr_basis_mat_mget(SAM_table ptr, int* nrows, int* ncols, SAM_error *err);
	...
	SAM_EXPORT double SAM_Merchantplant_Depreciation_depr_en_basis_mat_nget(SAM_table ptr, SAM_error *err);
	...
	SAM_EXPORT double SAM_Merchantplant_BatterySystem_en_wave_batt_nget(SAM_table ptr, SAM_error *err);
	...
	SAM_EXPORT double* SAM_Merchantplant_Outputs_cf_energy_purchases_aget(SAM_table ptr, int* length, SAM_error *err);
	...
	SAM_EXPORT double* SAM_Merchantplant_Outputs_cf_itc_fed_aget(SAM_table ptr, int* length, SAM_error *err);

	SAM_EXPORT double* SAM_Merchantplant_Outputs_cf_itc_fed_amount_aget(SAM_table ptr, int* length, SAM_error *err);

	SAM_EXPORT double* SAM_Merchantplant_Outputs_cf_itc_fed_percent_amount_aget(SAM_table ptr, int* length, SAM_error *err);

	SAM_EXPORT double* SAM_Merchantplant_Outputs_cf_itc_sta_aget(SAM_table ptr, int* length, SAM_error *err);

	SAM_EXPORT double* SAM_Merchantplant_Outputs_cf_itc_sta_amount_aget(SAM_table ptr, int* length, SAM_error *err);

	SAM_EXPORT double* SAM_Merchantplant_Outputs_cf_itc_sta_percent_amount_aget(SAM_table ptr, int* length, SAM_error *err);

	SAM_EXPORT double* SAM_Merchantplant_Outputs_cf_itc_total_aget(SAM_table ptr, int* length, SAM_error *err);
