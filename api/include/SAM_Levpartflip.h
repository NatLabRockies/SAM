...
extern "C"
{
	 ...
	 */
	SAM_EXPORT void SAM_Levpartflip_Depreciation_depr_basis_mat_mset(SAM_table ptr, double* mat, int nrows, int ncols, SAM_error *err);
	 ...
	 * required if: ?=0
	 */
	SAM_EXPORT void SAM_Levpartflip_Depreciation_depr_en_basis_mat_nset(SAM_table ptr, double number, SAM_error *err);
	...
	SAM_EXPORT double* SAM_Levpartflip_Depreciation_depr_basis_mat_mget(SAM_table ptr, int* nrows, int* ncols, SAM_error *err);
	...
	SAM_EXPORT double SAM_Levpartflip_Depreciation_depr_en_basis_mat_nget(SAM_table ptr, SAM_error *err);
